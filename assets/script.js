...
function setDisplay(lat, lon) {
    ...
    fetch(owFetchURL)
        ...
        .then(function (data) {
            ...
            $("#date1").html(d1Date);
            $("#img1").html("<img src='https://openweathermap.org/img/wn/" + d1Img + "@2x.png'>");
            $("#temp1").html(d1Temp);
            $("#wind1").html(d1Wind);
            ...
            $("#date2").html(d2Date);
            $("#img2").html("<img src='https://openweathermap.org/img/wn/" + d2Img + "@2x.png'>");
            $("#temp2").html(d2Temp);
            $("#wind2").html(d2Wind);
            ...
            $("#date3").html(d3Date);
            $("#img3").html("<img src='https://openweathermap.org/img/wn/" + d3Img + "@2x.png'>");
            $("#temp3").html(d3Temp);
            $("#wind3").html(d3Wind);
            ...
            $("#date4").html(d4Date);
            $("#img4").html("<img src='https://openweathermap.org/img/wn/" + d4Img + "@2x.png'>");
            $("#temp4").html(d4Temp);
            $("#wind4").html(d4Wind);
            ...
            $("#date5").html(d5Date);
            $("#img5").html("<img src='https://openweathermap.org/img/wn/" + d5Img + "@2x.png'>");
            $("#temp5").html(d5Temp);
            $("#wind5").html(d5Wind);
